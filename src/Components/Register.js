  ...
  return (
    <div className="temp" >
      ...
      <div className="design" >
        <input type="text" placeholder="Enter your name" onChange={nameChangeHandler} value={sName} />
        <input type="text" placeholder="Enter your Number" onChange={numberChangeHandler} value={number} />
        <input type="number" placeholder="Enter your age" onChange={ageChangeHandler} value={age} />
